export default function PowerBILicenses() {
  return (
    <main className="flex min-h-screen flex-col items-center p-24 w-10/12 m-auto">
      <h2 id="license-overview" className="text-2xl font-bold">
      ...
      <p>
        ...
        do exist. These include Power BI Pro and Power BI Premium. We were
        limited in regards to what we could do during the project because we did
        not have a budget. Below are some recommendations for the future of the
        project there was budget in the future. Note: Power BI has{" "}
      ...
      <div className="text-center pt-5">
        ...
        <h2 id="limitations" className="text-2xl pt-5 font-bold">
          Limitations
        </h2>
        <br />
        <p>
      ...
      <div className="text-center pt-5">
        <hr className="background-color: bg-black h-0.5" />
        <h2
          id="microsoft-developer-account"
          className="text-2xl pt-5 font-bold"
        >
        ...
        <p className="pb-5">
          ...
          developer account, but later decided against this since according to
          the{" "}
          ...
          activity were to be resumed in the future, utilizing a developer
          account could be a viable option.
        </p>
        <hr className="background-color: bg-black h-0.5" />
      </div>
    </main>
