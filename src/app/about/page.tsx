...
export default function about() {
  return (
    <main className="flex min-h-screen flex-col items-center p-24">
      ...
      <div>
        Hi, I am a senior computer science major at Hamilton College and am from
        CT. I am interested in full-stack development and will be moving to
        Portland, Oregon upon graduation to work as a software engineer at Nike.
        My favorite coding language is Python and outside of computer science
        classes, I enjoy talking environmental studies classes for my minor. At
        school, you can typically find me climbing at the school&apos;s rock
        wall, coding in the science center, or cycling around the farms nearby
        Hamilton&apos;s campus.
      </div>
      <br />
