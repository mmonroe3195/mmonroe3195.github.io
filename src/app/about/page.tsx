export default function about() {
  return (
    <main className="flex min-h-screen flex-col items-center p-24">
      ...
      <br/>
      <h2>Madison</h2>
      <div>Hi, I am a senior computer science major at Hamilton College. I am interested in 
        full-stack development and will be moving to Portland, Oregon upon graduation to work 
        as a software engineer at Nike. My favorite coding language is Python and outside of 
        computer science classes, I enjoy talking environmental studies classes. 
