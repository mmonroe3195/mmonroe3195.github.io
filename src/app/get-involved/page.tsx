    ...
    <div className="flex min-h-screen flex-col items-center justify-between p-24 w-10/12 m-auto">
      <div className="text-center">
        ...
        <h2 className="text-xl font-bold">Address Climate Change:</h2>
          ...
          This section is intended to provide resources to guide future action.
          <br/> <br/> <br/>
          ...
          climate change, you are equipt to teach others about what is really happening to the planet. Misinformation
          is a powerful weapon of climate change deniers, and learning what is really happening is a good way to 
